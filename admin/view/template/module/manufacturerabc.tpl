          ...
          <tr>
            ...
            <td class="left"><select name="manufacturerabc_module[<?php echo $module_row; ?>][position]">
				<?php if ($module['position'] == 'header_bottom') { ?>
				   <option value="header_bottom" selected="selected">Низ шапки</option>
				<?php } else { ?>
				   <option value="header_bottom">Низ шапки</option>
				<?php } ?>
...
function addModule() {	
	...
	html += '      <option value="header_bottom">Низ шапки</option>';
